...
class _ParityCompleteSE3Base(nn.Module):
    """Private construction and validation base for the canonical 3D core.
    ...
    Concrete subclasses provide the forward implementation.
    """
