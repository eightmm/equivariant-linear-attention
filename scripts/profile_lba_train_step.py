...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    checkpointed = result["arms"]["candidate_checkpointed"]
    incumbent = result["arms"]["incumbent"]
    result["comparison"] = {
        "forward_synchronized_wall_time_ratio": _ratio(
            candidate["stages"]["stage.forward"]["cpu_time_total_us"],
            incumbent["stages"]["stage.forward"]["cpu_time_total_us"],
        ),
        "backward_synchronized_wall_time_ratio": _ratio(
            candidate["stages"]["stage.backward"]["cpu_time_total_us"],
            incumbent["stages"]["stage.backward"]["cpu_time_total_us"],
        ),
